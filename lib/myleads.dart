...
class _MyleadsState extends StateMVC<Myleads>
    with SingleTickerProviderStateMixin {
  AdminController? _con;

  _MyleadsState() : super(AdminController()) {
  ...
  getUserId() async {
    ...
    _con!.getleads(userId,businessId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 5.0,
          bottomOpacity: 0.0,
          title: Text("My Leads",style: TextStyle(color: Colors.white,fontSize: 18),),
