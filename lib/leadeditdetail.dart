...
class LeadEditDetail extends StatefulWidget {
  String id;
  LeadEditDetail({required this.id});
  @override
  _LeadEditDetailState createState() => _LeadEditDetailState();
}

class _LeadEditDetailState extends StateMVC<LeadEditDetail>
    with SingleTickerProviderStateMixin {
  AdminController? _con;

  _LeadEditDetailState() : super(AdminController()) {
  ...
  Future getleadinfo(id)async {
    ...
    setState(() {
      _lead_nameController.text = qData != null ? qData[0]["lead_name"].toString() : "";
      _qualificationController.text = qData != null ? qData[0]["qualification"].toString() : "";
      selCatcampId  = qData != null ? qData[0]["campaign_id"] : "";
      selCat = qData != null ? qData[0]["status_id"] : "";
      _follow_up_dateController.text = qData != null ? qData[0]["follow_up_date"].toString() : "";
      _phone_numberController.text = qData != null ? qData[0]["phone_number"].toString() : "";
  ...
  submit() async {
    ...
    _showSheet();
    _con!.leadupdate(context,widget.id,userId,_lead_nameController.text,_qualificationController.text,selCatcamp,selCat,_follow_up_dateController.text,_phone_numberController.text);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 5.0,
          bottomOpacity: 0.0,
          title: Text("Edit Lead Details ",style: TextStyle(color: Colors.white,fontSize: 18),),
