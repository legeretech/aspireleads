...
class _RegistrationState extends StateMVC<Registration> with SingleTickerProviderStateMixin {

  AdminController? _con;

  _RegistrationState() : super(AdminController()) {
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                ...
                                                Align(
                                                    alignment: Alignment.centerLeft,
                                                    child:Text("Hola wallet is a members-only payment network.You need a referral code to signup with Hola Wallet.",
                                                      style: TextStyle(color: Color(0xFF575757), fontSize: 13),textAlign: TextAlign.left,)),
                                                ...
                                                Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    validator: (value) => value!.isEmpty ? 'Referral Code cannot be blank' : null,
